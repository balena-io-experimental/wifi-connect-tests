...
*/
    ...
    if(WIFI_SSID != null){
      console.log(`Connecting ${IFACE} to WiFi with SSID "${WIFI_SSID}" and password "${WIFI_PASSWORD}"`);
      await connectToWifi({ iface: IFACE, ssid: WIFI_SSID, password: WIFI_PASSWORD });
    } else{
      console.log("NO SSID GIVEN");
    }
